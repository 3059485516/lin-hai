...
public class KjxqPresenter extends AListPresenter<IListView, KjcgListEntity> {
    public KjxqPresenter(IListView view) {
        super(view);
    }
    ...
    public void getPageData(boolean isRefresh) {
        ...
        addRx2Destroy(new RxSubscriber<KjcgEntity>(Api.getScienceList(getPage() + "")) {
            @Override
