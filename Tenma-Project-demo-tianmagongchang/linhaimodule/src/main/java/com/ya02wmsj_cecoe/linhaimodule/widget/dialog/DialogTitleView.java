...
public class DialogTitleView extends FrameLayout {
    ...
    private void init() {
        inflate(getContext(), R.layout.ya02wmsj_cecoe_view_dialog_header, this);
    ...
    public void setMode(int mode) {
        int padding = (int) getContext().getResources().getDimension(R.dimen.yl_global_dialog_padding);
        if (mode == MODE_SMALL) {
