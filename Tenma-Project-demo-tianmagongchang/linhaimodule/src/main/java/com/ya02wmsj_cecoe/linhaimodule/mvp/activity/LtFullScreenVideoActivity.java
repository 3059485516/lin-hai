...
import com.ya02wmsj_cecoe.linhaimodule.mvp.presenter.LtFullScreenVideoPresenter;
...
public class LtFullScreenVideoActivity extends BaseActivity<FullScreenVideoContract.Presenter> implements FullScreenVideoContract.View {
    ...
    protected void initMVP() {
        mPresenter = new LtFullScreenVideoPresenter(this);
    }
    ...
    protected void initView() {
        ...
        mCurrentSeel = getIntent().getIntExtra(Constant.KEY_INT_1, -1);
    ...
    public void updateView(Object obj) {
        ...
        if (mNodeContent.getVideo_path() != null) {
            ...
            if (mCurrentSeel > 0) {
                mSoonCoverVideo.setSeekOnStart(mCurrentSeel);
            }
