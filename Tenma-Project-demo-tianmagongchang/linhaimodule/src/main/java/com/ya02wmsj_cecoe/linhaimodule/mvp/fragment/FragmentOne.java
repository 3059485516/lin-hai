 ...
 */
public class FragmentOne extends BaseListFragment<FragmentOneContract.Presenter>
        implements FragmentOneContract.View {
    ...
    private boolean mHideTab = true;
    List<String> titles = new ArrayList<>();
    TextSwitcherAnimation animation;
...
//        setDefaultItemDecoration();
    ...
    public void updateTips() {
        if (mPresenter.getTipsList().size() > 0) {
            ...
            animation.create();
            mTextSwitch.setOnClickListener(new View.OnClickListener() {
                @Override
