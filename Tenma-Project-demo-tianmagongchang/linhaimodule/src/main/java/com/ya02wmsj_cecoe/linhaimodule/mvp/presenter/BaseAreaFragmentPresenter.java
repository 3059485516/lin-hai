 ...
 */
public class BaseAreaFragmentPresenter extends BaseAreaFragmentContract.Presenter {
    private List<AppraiseEntity> mNodeContentList = new ArrayList<>();

    public BaseAreaFragmentPresenter(BaseAreaFragmentContract.View view) {
        super(view);
    }
    ...
    public void getOnlineActivityList() {
        addRx2Destroy(new RxSubscriber<List<AppraiseEntity>>(Api.getOnlineActivityList("1", "100", RegionManager.getInstance().getCurrentCountyCode(), "")) {
            @Override
