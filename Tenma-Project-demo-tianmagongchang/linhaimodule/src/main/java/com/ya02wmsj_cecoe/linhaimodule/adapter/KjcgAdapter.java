...
import com.ya02wmsj_cecoe.linhaimodule.mvp.activity.KjcgDetailActivity;
...
public class KjcgAdapter extends CommonAdapter<KjcgListEntity> {
    public KjcgAdapter(Context context, List<KjcgListEntity> datas) {
    ...
    protected void convert(ViewHolder holder, KjcgListEntity kjcgListEntity, int position) {
        ...
        holder.setText(R.id.tv_palce, kjcgListEntity.getPlace());
        ...
        holder.getConvertView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, KjcgDetailActivity.class);
