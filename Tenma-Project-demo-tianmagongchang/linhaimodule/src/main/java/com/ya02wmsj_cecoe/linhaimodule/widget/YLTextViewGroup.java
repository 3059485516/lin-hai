...
public class YLTextViewGroup extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.ya02wmsj_cecoe_text_view_group, this, true);
        if (attrs == null) {
            return;
        }
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.YLTextViewGroup);
        mTextLeft = typedArray.getString(R.styleable.YLTextViewGroup_text_left);
