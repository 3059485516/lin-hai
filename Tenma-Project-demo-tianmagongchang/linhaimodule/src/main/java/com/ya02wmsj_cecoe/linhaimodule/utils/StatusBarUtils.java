...
public class StatusBarUtils {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.yl_statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.yl_statusbarutil_translucent_view;
