...
import com.ya02wmsj_cecoe.linhaimodule.widget.dialog.DialogTitleView;
...
public class CommonDialog extends Dialog {
    ...
    public CommonDialog(Context context, int defStyle) {
        ...
        contentPadding = (int) getContext().getResources().getDimension(R.dimen.yl_global_dialog_padding);
        init(context);
    }
    ...
    protected void init(final Context context) {
        ...
        content = LayoutInflater.from(context).inflate(R.layout.ya02wmsj_cecoe_dialog_common, null);
    ...
    public void setMessage(Spanned spanned) {
        ...
        tvMessage.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT));
        ...
        ScrollView.LayoutParams lp = new ScrollView.LayoutParams(ScrollView.LayoutParams.MATCH_PARENT, ScrollView.LayoutParams.WRAP_CONTENT);
    ...
    public void setNegativeButton(String text, final OnClickListener listener) {
        if (!TextUtils.isEmpty(text)) {
            ...
            negativeBt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (listener != null) listener.onClick(CommonDialog.this, 0);
                    else dismissClick.onClick(CommonDialog.this, 0);
                }
            });
        ...
        else barDivider.setVisibility(View.GONE);
    }
