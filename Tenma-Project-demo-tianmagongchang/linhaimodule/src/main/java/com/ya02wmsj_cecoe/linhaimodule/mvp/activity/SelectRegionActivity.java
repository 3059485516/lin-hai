 ...
 */
public class SelectRegionActivity extends BaseActivity<BindRegionContract.Presenter> implements BindRegionContract.View {
    ...
    protected void initView() {
        ...
        findViewById(R.id.btn_bind).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constant.KEY_STRING_1, mTvRegionVillage.getTextRight());
                intent.putExtra(Constant.KEY_STRING_2, String.valueOf(mTvRegionVillage.getTag()));
