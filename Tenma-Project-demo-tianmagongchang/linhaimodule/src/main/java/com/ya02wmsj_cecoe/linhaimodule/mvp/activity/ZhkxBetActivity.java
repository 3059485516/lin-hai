...
public class ZhkxBetActivity extends BaseActivity<ZhkxPresenter> implements ZhkxContract.View {
    ...
    protected void initView() {
        setTitle("智慧科普");
        findViewById(R.id.iv_qk).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.iv_sc).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.iv_zjk).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.iv_gkk).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
